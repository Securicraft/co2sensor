# https://github.com/octaprog7/SCD4x/blob/master/scd4x_sensirion.py
"""SCD4x Sensirion module"""

import bus_service
from base_sensor import BaseSensor, Iterator
import base_sensor
from crc_mod import crc8
import micropython
import utime
...
class SCD4xSensirion(BaseSensor, Iterator):
    ...
    def __init__(self, adapter: bus_service.BusAdapter, address=0x62,
        ...
        """this_is_scd41 == True, то SCD41, SCD40/41!
